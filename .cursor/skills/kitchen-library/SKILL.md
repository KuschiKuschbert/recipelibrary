...
| `riviera_sources/current/Riviera_Source_Of_Truth_2026-07-08.md` | **Riviera SSOT:** the 23 live ChatGPT Riviera project sources are the baseline; `Riviera_Tapas_House_Standards_Overlay_2026-07-08.md` is the only July 8 overlay for the 16 tapas/canape house standards. Rebuild with `python3 scripts/build_riviera_source_of_truth.py`. Treat `riviera_data/builtins.json`, `function_packages.json`, and generated PDFs as operational representations for non-overlay conflicts. |
