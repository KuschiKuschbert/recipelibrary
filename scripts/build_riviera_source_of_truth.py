...
ALIGNMENT_RECORD_PATH = OUTPUT_DIR / "Riviera_V15_2_Alignment_2026-08-29.md"

DRIVE_RELEASE = {
    "status": "active",
    "activeReleaseManifestId": "1gymFSa18m_CGVzm2aMBGQ5arA5OiQSNuVg6niLoF6lk",
    "sourceMapId": "1mNd47CHbi704CqmZQeIt5WzykmVxW_TglNchQELYKv0",
    "recipeSourceAdapterId": "14ARSDcPNUFvMfVTzcUbrd4-51BKdAdhiGBj-yRsBgxE",
    "costingWorkbookId": "1gThBJ-dWytj-1iUjl4bSdZmgCU3bbxvP",
    "menuBuilderId": "1k380sC6o0XJj6pZN_bMtDac5_ZgtOHvd4KwzKB0F3Q4",
    "chatgptProjectRetrievalStatus": "PENDING",
}
...
def build_source_of_truth(
    ...
    lines: list[str] = [
        ...
        "**Drive release alignment:** RIV-KNOWLEDGE-V15.2 is active in Drive. Source swap and Drive readback are complete; live ChatGPT Project retrieval remains pending.",
        ...
        "8. Apply the active Drive Recipe Source Adapter when reconciling costing-workbook cards with GitHub. Match the exact recipe title and service module; do not merge similarly named dishes or transfer a yield between service formats.",
        "9. Do not silently invent missing recipe, package, dietary, ordering, or service rules. Mark `NEEDS CONFIRMATION` or `WAITING` when sources conflict or a required detail is absent.",
        "10. Temporary event/week instructions require an expiry and must not be promoted into a permanent SOP.",
        "",
        "## Active Source Stack",
        "",
...
def expected_manifest(inventory: list[dict[str, Any]]) -> dict[str, Any]:
    return {
        ...
        "alignmentRecord": str(ALIGNMENT_RECORD_PATH.relative_to(ROOT)),
        "driveRelease": DRIVE_RELEASE,
